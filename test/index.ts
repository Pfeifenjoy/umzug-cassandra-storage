...
describe("cassandra storage", () => {
	...
	it("sync use old migrations table", async () => {
		...
		await cassandraStorage1.logMigration({ name: "migration-1", context: { } })
	...
	it("log migration", async () => {
		...
		await cassandraStorage.logMigration({ name: "migration-1", context: { } })
	...
	it("unlog migration", async () => {
		...
		await cassandraStorage.unlogMigration({ name: "migration-1", context: { } })
